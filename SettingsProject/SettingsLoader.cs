            ...
            ImmutableArray.Create(
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 10,
                        editorType: "String"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "ConsoleApp1", "$(ProjectName)")),
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 200,
                        editorType: "String"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "ConsoleApp1", "$(DefaultNamespace)")),
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 300,
                        editorType: "Bool"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, false, "false")),
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 310,
                        editorType: "String"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "net5", "net5")),
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 320,
                        editorType: "Enum"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, ".NET 5", ".NET 5")
                    {
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 500,
                        editorType: "Enum"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "Console Application", "Console Application")
                    {
                        EnumValues = ImmutableArray.Create(
                            "Console Application",
                            "Windows Application",
                ...
                new Setting(
                    ...
                    new SettingValue(ImmutableDictionary<string, string>.Empty, true, "true")),
                new Setting(
                    new SettingMetadata(
                        name: "Startup object",
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "(Not set)", "(Not set)")
                    {
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 800,
                        editorType: "Enum"),
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "Icon and manifest", "Icon and manifest")
                    {
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 810,
                        editorType: "String"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "(Default Icon)", "(Default Icon)")),
...
//                    category: "Assembly Information"),
                ...
                new Setting(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "TRACE", "TRACE")),
                new Setting(
                    new SettingMetadata(
                    ...
                    values: ImmutableArray.Create(
                        new SettingValue(DebugConfiguration, evaluatedValue: true, "true"),
                        new SettingValue(ReleaseConfiguration, evaluatedValue: false, "false"))),
                new Setting(
                    new SettingMetadata(
                ...
                new Setting(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "Any CPU", "Any CPU")
                    {
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 500,
                        editorType: "Enum"),
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "Enable", "enable")
                    {
                ...
                new Setting(
                    ...
                    values: ImmutableArray.Create(
                        new SettingValue(DebugConfiguration, evaluatedValue: false, "false"),
                        new SettingValue(ReleaseConfiguration, evaluatedValue: true, "true"))),
                ...
                new Setting(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "4", "4")
                    {
                ...
                new Setting(
                    ...
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "1701;1702", "1701;1702")),
                new Setting(
                    new SettingMetadata(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "Specific warnings", "Specific warnings")
                    {
                ...
                new Setting(
                    ...
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "NU1605", "NU1605")),
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 400,
                        editorType: "Enum"),
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "Auto", "Auto")
                    {
                ...
                new Setting(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "Prompt", "Prompt")
                    {
                ...
                new Setting(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "Portable", "Portable")
                    {
                ...
                new Setting(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "512", "512")
                    {
                ...
                new Setting(
                    ...
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "0x11000000", "0x11000000")),
                ...
                new Setting(
                    ...
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "On successful build", "On successful build")
                    {
                        EnumValues = ImmutableArray.Create(
                            "Always",
                            "On successful build",
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 400,
                        editorType: "String"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "1.0.0", "$(Version)")),
                new Setting(
                    new SettingMetadata(
                        name: "Authors",
                        description: null,
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 1600,
                        editorType: "String"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "(None)", "(None)")),
                // TODO VersionSetting
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 1700,
                        editorType: "String"),
                    new SettingValue(ImmutableDictionary<string, string>.Empty, "1.0.0.0", "1.0.0.0")),
                // TODO VersionSetting
                new Setting(
                    new SettingMetadata(
                ...
                new Setting(
                    new SettingMetadata(
                        ...
                        priority: 200,
                        editorType: "Enum"),
                    value: new SettingValue(ImmutableDictionary<string, string>.Empty, "None", "None")
                    {
